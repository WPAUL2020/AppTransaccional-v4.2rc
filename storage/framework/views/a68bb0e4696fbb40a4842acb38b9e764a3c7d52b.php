...
<div class="container">
   <table class="table table-bordered table-hover text-center">
                ...
                <a class="btn btn-outline-secondary" href="<?php echo e(URL::to('GestionUser')); ?>">Desactivar</a>
                <a class="btn btn-outline-secondary" href="<?php echo e(URL::to('Clientes/agregar')); ?>">Agregar</a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BigDataII\resources\views/GestionClientes.blade.php ENDPATH**/ ?>