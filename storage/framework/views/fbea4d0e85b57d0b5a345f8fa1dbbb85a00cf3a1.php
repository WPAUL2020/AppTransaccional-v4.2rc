...
<div class="container fondo_container">
        <div class="row">
            <div class="col-md-5">
                <h2 class="col"> E<span>DITAR</span> E<span>MPLEADO</span>: <?php echo e($EmpleadosInterno->NOMBRE); ?></h2>
                <div class="form-row">
                </div>
                </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/AppTransaccional-v4.2rc/resources/views/GestUserIntEdit.blade.php ENDPATH**/ ?>