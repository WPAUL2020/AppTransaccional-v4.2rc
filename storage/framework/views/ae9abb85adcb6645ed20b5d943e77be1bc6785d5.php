...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
        ...
        <div class="row justify-content-sm-center">
            <?php if(Route::has('login')): ?>
                ...
                <a class="btn btn-outline-secondary" href="../pdfs/LibroDummies.pdf">Documentación App</a>
    ...
    <div class="col-md-6">
        <img style="height: 700px;" src="<?php echo e(asset('Imagenes/Servicios.png')); ?>" alt="">
    </div>
...
<?php /**PATH C:\xampp\htdocs\AppTransaccional v3.2rc\resources\views/Sevicios.blade.php ENDPATH**/ ?>