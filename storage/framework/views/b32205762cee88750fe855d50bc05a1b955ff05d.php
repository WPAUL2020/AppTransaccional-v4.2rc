...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Registro de Usuarios Nuevos')); ?></div>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            <label for="rol" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Rol del Usuario')); ?></label>
                            <div class="col-md-6">
                            <td><select name="rol">
                                <option></option>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            <label for="estado" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Estado del Usuario')); ?></label>
                            <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BigDataII\resources\views/auth/register.blade.php ENDPATH**/ ?>