            ...
            <div class="col-md-5">
                ...
                <label>Digitar nombre del sector</label>
                    ...
                    <div class="form-group">
                        ...
                        <a class="btn btn-outline-secondary" href="<?php echo e(URL::to('Sector')); ?>">Regresar</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/BigDataII/resources/views/SectEmprTerCrear.blade.php ENDPATH**/ ?>