...
<body>
    ...
    <form method="POST" action="<?php echo e(URL:: to("GestUserIntVista/changeUser/$EmpleadosTercero->ID_EMPLEADO_TERCERO")); ?>"> <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/AppTransaccional v3.2rc/resources/views/GesUserTerEdit.blade.php ENDPATH**/ ?>