<?php $__env->startSection('content'); ?>
    ...
    <section class="breadcrumb">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <img src="<?php echo e(asset('Imagenes/editarempresa.png')); ?>">
        ...
        <div class="container fondo_container">
            <div class="row">
                    <div class="col-md-5">
                        <h2 class="col"> E<span>DITAR </span>E<span>MPRESA</span>: <?php echo e($clientes->NOMBRE); ?></h2>
                        <div class="form-row">
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git\AppTransaccional-v4.2rc\resources\views/GestionClientesEdit.blade.php ENDPATH**/ ?>