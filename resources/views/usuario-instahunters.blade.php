        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <ol class="bc-3">
                            <li>
                    <a href="{{URL::to('appl4')}}"> <i class="fas fa-angle-left"></i> Regresar</a>
                </li>
                    <li class="active">
                ...
                <div class="card-body display-4">
                    <form method="POST" action="{{ route('scrapPost') }}" class="form-horizontal"> {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{URL::to('cliente-instahuntersvista')}}" class="btn btn-info float-right btn-lg">
